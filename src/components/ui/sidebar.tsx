...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Legitimate use for storing sidebar state
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: setOpen and setOpenMobile are stable functions from useState
